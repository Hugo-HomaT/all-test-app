...
/// <summary>
/// Simple component used by ObjectivesUISystem to animate a sprite
/// from the hole position to its objective card.
/// </summary>
...
public class ObjectivePickupIcon : MonoBehaviour
{
    ...
    private IEnumerator PlayRoutine(Vector2 start,
                                    Vector2 controlA,
                                    Vector2 controlB,
                                    Vector2 endPoint,
                                    float duration,
    ...
    private static Vector2 EvaluateCubicBezier(Vector2 a, Vector2 b, Vector2 c, Vector2 d, float t)
    {
        ...
        float tSqr = t * t;
        return oneMinusTSqr * oneMinusT * a
               + 3f * oneMinusTSqr * t * b
               + 3f * oneMinusT * tSqr * c
               + tSqr * t * d;
    }
